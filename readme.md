...
4.  **Diseño Premium**: Interfaz moderna con efectos de *Glassmorphism* y diseño responsivo.
...
*   `src/app/core`: Modelos e interfaces de datos, y servicios globales (Lógica de cálculo).
*   `src/app/shared`: Componentes reutilizables de UI.
*   `src/app/features`: Módulos de funcionalidad (Listado, Formulario, Detalle).
